...
import org.javaturk.jp.ch24.constants.DateConstants;
import org.javaturk.jp.ch24.date.dateEnums.DayOfMonth;
...
class DateTest {
	...
	public static void main(String[] args) {
		...
		Date1 ed3 = new Date1(DateConstants.DAY_8, DateConstants.JANUARY, DateConstants.YEAR_2029);

		Date4 ed4 = new Date4(DayOfMonth.DAY_4, Month.AUGUST, Year.YEAR_2026);
